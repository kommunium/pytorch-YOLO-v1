...
class yoloLoss(nn.Module):
    ...
    def forward(self, pred_tensor, target_tensor):
        ...
        # noo pred only need to calculate the loss of c size[-1,2]
        ...
        # loc_loss_1 = F.mse_loss(box_pred_response[:, :2], box_target_response[:, :2], reduction='sum')
        # loc_loss_2 = F.mse_loss(torch.sqrt(box_pred_response[:, 2:4]), torch.sqrt(box_target_response[:, 2:4]),
        #                         reduction='sum')
